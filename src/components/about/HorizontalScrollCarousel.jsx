...
const cards = [
  ...
  },
  {
    ...
    title: (
      <>
        Verified Profiles <br /> & Secure Space
      </>
    ),
    para: (
      <>
      ...
      {isMobile ? (
        <div className="sticky top-0 flex h-screen flex-col items-center overflow-hidden">
          ...
          <div
            ...
            className="flex h-[100vh] items-center overflow-x-auto cursor-grab active:cursor-grabbing gap-4 px-4"
          >
            {cards.map((card) => (
    ...
    >
      {isMobile ? (
        ...
        <>
          ...
          />
          <p className="absolute top-10 left-10 font-openSans">{card.id}</p>
